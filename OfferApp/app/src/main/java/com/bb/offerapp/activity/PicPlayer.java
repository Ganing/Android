...
public class PicPlayer extends Activity implements Runnable {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.picplayer_main);
        initView();
    ...
    private class BannerAdapter extends PagerAdapter implements ViewPager.OnPageChangeListener {
        ...
        public Object instantiateItem(ViewGroup container, int position) {
            position %= DEFAULT_BANNER_SIZE;
            View view = mInflater.inflate(R.layout.player_item, container, false);
            ...
            view.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(PicPlayer.this, "click banner item :" + pos, Toast.LENGTH_SHORT).show();
                }
            });
